...
addSize.addEventListener('click', () => {
  ...
  <button type="button" id="removesize-${uuid}" data-removesize="size-${uuid}" class="removeSizeButtons border border-black bg-black flex justify-center" style="min-width: 44px;">
